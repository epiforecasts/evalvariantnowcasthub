...
![Fig. S17 Ratio of the number of sequences available in the NCBI GenBank dataset for California compared to the California-specific dataset across collection dates for a subset of nowcast dates (columns). Patterns indicate that even further back in time, the GenBank dataset at most makes up between 50% and 90% of the California specific data volume, with a particular drop off closer to the nowcast date.](../output/figs/supp/CA_source_seq_level_comparison.png)
